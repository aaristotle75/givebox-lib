      ...
      urlInput =
        <div>
            ...
            onKeyDown={this.onLinkInputKeyDown}
					...
					/>
          <button className='link' onMouseDown={this.cancelLink}>Cancel</button>
          <button style={{ marginLeft: 10 }} className='link' onMouseDown={this.confirmLink}>Confirm</button>
				</div>;
    }
...
const InlineStyleControls = (props) => {
	...
	return (
		<div className='RichEditor-controls'>
			{props.allowLink ? <span onMouseDown={props.promptForLink} className='RichEditor-styleButton'>Add Link</span> : ''}
			{props.allowLink ? <span onMouseDown={props.removeLink} className='RichEditor-styleButton'>Remove Link</span> : ''}
